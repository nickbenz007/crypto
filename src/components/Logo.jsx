...
const Logo = () => {
  return (
    <div className="md:px-16 px-4 md:py-3 py-4 items-center justify-center content-center hover:scale-110 transition-all duration-300 delay-300">
      <Link to={"/"}>
        <svg
          className="md:w-12 w-10 md:h-16 h-12 object-contain"
          viewBox="0 0 51 40"
          fill="none"
